    ...
    'items' => array(
        ...
        array('label' => '<span class="menu-text">' . strtoupper(sysMenuItem()) . '</span>',
            ...
            'items' => array(
                ...
                array('label' => sysMenuBarcode(),
                    'icon' => 'menu-icon '  . 'menu-icon fa fa-barcode pink',
                    'url' => url('Item/printBarcodeLabel'),
                    'active' => $this->id . '/' . $this->action->id== 'item/printBarcodeLabel',
                    'visible' => ckacc('item.create') || ckacc('item.read') || ckacc('item.update') || ckacc('item.delete'),
                ),
            ),
        ),
        array('label' => '<span class="menu-text">' . strtoupper(sysMenuInventory()) . '</span>',
            ...
            'active' => $this->id . '/' . $this->action->id == 'receivingItem/index' || $this->id . '/' . $this->action->id == 'receivingItem/inventoryCountCreate' || $this->id  == 'receiving' || $this->id . '/' . $this->action->id == 'receivingItem/itemCountList',
        ...
        array('label' => '<span class="menu-text">' . strtoupper(sysMenuPurchase()) . '</span>',
            ...
            'url' => url('receivingItem/index'),
            'active' => $this->id . '/' . $this->action->id == 'receivingItem/index' && $this->id . '/' . $this->action->id . '/' . Yii::app()->request->getQuery('trans_mode') != 'receivingItem/index/physical_count' || $this->id . '/' . $this->action->id == 'receivingItem/list',
            ...
            'items' => array(
                array('label' => sysMenuPurchaseReceive(),
                    ...
                    'url' => url('receivingItem/list', array('tran_type' => '1','user_id'=>getEmployeeId())),
                    'active' => $this->id . '/' . $this->action->id . '/' . Yii::app()->request->getQuery('tran_type') . '/' . Yii::app()->request->getQuery('user_id') == 'receivingItem/list/1/'.getEmployeeId(),
                    'visible' => ckacc('purchasereceive.read')),
                array('label' => sysMenuPurchaseReturn(),
                    'icon' => 'menu-icon '  . sysMenuPurchaseReturnIcon(),
                    'url' => url('receivingItem/list', array('tran_type' => '2','user_id'=>getEmployeeId())), 
                    'active' => $this->id . '/' . $this->action->id . '/' . Yii::app()->request->getQuery('tran_type') . '/' . Yii::app()->request->getQuery('user_id') == 'receivingItem/list/2/'.getEmployeeId(),

                    //$this->id . '/' . $this->action->id . '/' . Yii::app()->request->getQuery('trans_mode') == 'receivingItem/index/return',
