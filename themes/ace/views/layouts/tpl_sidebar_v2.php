...
$this->widget('bootstrap.widgets.TbNav', array(
    ...
    'items' => array(
        array('label' => '<span class="menu-text">' . sysMenuDashboard() . '</span>', 'icon' => 'menu-icon fa fa-tachometer',
            'url' => Yii::app()->urlManager->createUrl('dashboard/view'),
        ...
        array('label' => '<span class="menu-text">' . sysMenuItem() . '</span>', 'icon' => 'menu-icon fa fa-coffee',
            'url' => Yii::app()->urlManager->createUrl('item'),
            'active' => $this->id == 'item',
            ...
            'items' => array(
                array('label' => sysMenuItemAdd(), 'icon' => 'menu-icon fa fa-plus pink',
                    'url' => Yii::app()->urlManager->createUrl('item/create'),
        ...
        array('label' => '<span class="menu-text">' . sysMenuPurchase() . '</span>', 'icon' => 'menu-icon fa fa-money',
            'url' => Yii::app()->urlManager->createUrl('receivingItem/index'),
            'active' => $this->id . '/' . $this->action->id == 'receivingItem/index',
            'visible' => Yii::app()->user->checkAccess('transaction.receive') || Yii::app()->user->checkAccess('transaction.return') || Yii::app()->user->checkAccess('transaction.adjustin') || Yii::app()->user->checkAccess('transaction.adjustout') || Yii::app()->user->checkAccess('transaction.count'),
            'items' => array(
        ...
        array('label' => '<span class="menu-text">' . sysMenuSale() . '</span>', 'icon' => sysMenuSaleIcon(),
            ...
            'items' => array(
                ...
                array('label' => sysMenuSaleView(), 'icon' => 'menu-icon fa fa-eye pink',
                    'url' => Yii::app()->urlManager->createUrl('saleItem/list'),
