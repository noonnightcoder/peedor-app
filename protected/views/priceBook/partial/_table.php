            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="130">
                            <div class="col-sm-12">
                                <input type="text" onkeyup="updateItem('','markupall','')" class="txt-markupall form-control textbox" value="0">
                            </div>
                        </td>
                        <td width="130">
                            <div class="col-sm-12">
                                <input type="text" onkeyup="updateItem('','discountall','')" class="txt-discountall form-control textbox" value="0">
                            </div>
                        </td>
                    </tr>
