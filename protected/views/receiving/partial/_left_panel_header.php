    ...
    <div class="widget-main">
        <div id="itemlookup"  class="col-xs-12 col-sm-10">
            <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
                'action'=>Yii::app()->createUrl('receiving/addItemToTransfer'),
                'method'=>'post',
        ...
        <?php if(!empty($items)):?>
            <?php
                $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
                    ...
                    'action' => Yii::app()->createUrl('receiving/resetItemToTransfer/'),
            ...
            ?>
                <?php
                    echo TbHtml::linkButton(Yii::t('app', ''), array(
                        ...
                        'url' => Yii::app()->createUrl('receiving/resetItemToTransfer/'),
