    ...
    function addPriceRange(iid=0){
        ...
        $('#price-range').append('\
            ...
            <div class="row">\
    			...
    			<div class="col-sm-2">\
                    <div class="form-group col-sm-12">\
    				    <input type="number" name="price_quantity[price_qty'+id+'][to_quantity]" id="ItemPriceQuantity_to_quantity" class="txt-to-qty'+id+' form-control" placeholder="To" onBlur="getValue('+id+')">\
    				</div>\
    			</div>\
    			<div class="col-sm-2">\
                    <div class="form-group col-sm-12">\
