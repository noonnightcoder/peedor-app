 ...
 * @property Item $item
 */
class ClientImage extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('client_id, filename', 'required'),
			array('client_id, size', 'numerical', 'integerOnly'=>true),
			...
			array('id, client_id, photo, thumbnail, filename, filetype, path, size, width, height', 'safe', 'on'=>'search'),
		);
	}
	...
	public function saveClientImage($client_id,$filename)
	{
