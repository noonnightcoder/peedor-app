...
class ReportColumn extends CModel
{
    ...
    public static function getSaleOrderColumns() {
        return array(
            ...
            array(
                'name' => 'Action',
                'value' => 'CHtml::link("Approve", Yii::app()->createUrl("SaleItem/SaleApprove",array(
                                   "sale_id" => $data["sale_id"],
                                   "status" => "1",
                                    "customer_id"=>$data["client_id"],
                                    "total"=>$data["total"],
                                    )),
                                    array("class"=>"btn btn-info btn-xs btn-order-approve"))',
                'type' => 'raw',
            ),
            array(
                'name' => 'Disapprove',
                'value' => 'CHtml::link("Disapprove", Yii::app()->createUrl("SaleItem/SaleApprove",array(
                                   "sale_id"=>$data["sale_id"],
                                   "status"=>$data["status"],
                                    "customer_id"=>$data["client_id"],
                                    "total"=>$data["total"],
