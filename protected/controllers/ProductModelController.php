...
class ProductModelController extends Controller
{
    ...
    public function accessRules()
    {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions'=>array('create','update','GetProductModel2','initProductModel','SaveProductModel'),
                'users'=>array('@'),
            ),
    ...
    public function actionSaveProductModel(){
        $model=new ProductModel;
        $product_model=$_POST['name'];
        $id = $model->saveProductModel($product_model);
        if($id){
            echo 'success';
            //print_r($model);
            $this->renderPartial('partialList/_product_model_reload',array('model'=>ProductModel::model()->findAll(),'id'=>$id));
        }else{
            echo 'existed'; 
        }
    }
