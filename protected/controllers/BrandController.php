...
class BrandController extends Controller
{
    ...
    public function accessRules()
    {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions'=>array('create','update','GetBrand2','initBrand','SaveBrand'),
                'users'=>array('@'),
            ),
    ...
    public function actionSaveBrand(){
        ...
        $id = $model->saveBrand($brand_name);
        if($id){
            echo 'success';
            //print_r($model);
            $this->renderPartial('partialList/_brand_reload',array('model'=>Brand::model()->findAll(),'id'=>$id));
        }else{
            echo 'existed'; 
        }
    }
