...
class ProductTypeController extends Controller
{
    ...
    public function accessRules()
    {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions'=>array('create','update','GetProductType2','initProductType','SaveProductType'),
                'users'=>array('@'),
            ),
    ...
    public function actionSaveProductType(){
        ...
        $id = $model->saveProductType($product_type_name);
        if($id){
            echo 'success';
            //print_r($model);
            $this->renderPartial('partialList/_product_type_reload',array('model'=>ProductType::model()->findAll(),'id'=>$id));
        }else{
            echo 'existed'; 
        }
    }
